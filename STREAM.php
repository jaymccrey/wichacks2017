  ...
  <form action="Yan-Test/personal_profile.php" method="post">
  	<table align="left">
  		...
  		<tr>
				...
				<td>
							<select id='friends' name='friends' class='dropdown' >
	...
	<div>
		<button type="submit" class="btn btn-primary " >Go</button>	  
                ...
                <!-- Date/Time -->
                <p class="nameHeader">
                  <a href="Jayme.php">Jayme McCreary's</a> LIT tunes of the week
                </p>
                <p class="datePosted">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"> <a class="commentName" href="Lauren.php">Lauren Mulvehill </a>
                ...
                <!-- Date/Time -->
                <p class="nameHeader">
                   <a href="Lauren.php">Lauren Mulvehill's</a> LIT tunes of the week
                </p>
                <p class="datePosted">
                    <span class="glyphicon glyphicon-time"></span>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"> <a class="commentName" href="Jayme.php">Jayme McCreary</a>
                            <small>August 25, 2014 at 9:30 PM</small>
                        </h4>
                        Great tunes!
                    </div>
                ...
                <p class="nameHeader">
                   <a href="Yangyan.php">Yangyan Dong's</a> LIT tunes of the week
                </p>
                <p class="datePosted">
                    <span class="glyphicon glyphicon-time"></span>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"> <a href="Lauren.php" class="commentName">Lauren Mulvehill </a>
                            <small>August 25, 2014 at 9:30 PM</small>
                        </h4>
                        Awesome!!
                    </div>
