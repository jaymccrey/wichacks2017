<html>
    ...
    <br>
           <div class="userContainer clearfix">
               <div class="profilePictureContainer">
                   <img class="profilePicture" src="img/yangyan.jpg" />
               </div>
               <div class="userInfo">
                      <strong>Name:</strong> Yangyan
                               ...
                               <button class="redButton" type="button">SoundCloud</button>
                                ...
                                <form action="update-songs.php" method="Post">
                                  ...
                                  <div class="srcSong">
                                  	...
                                  	<div class='button'>
                                 <input type='hidden' name='person' value='Yangyan' />
  ...
  ?>
						    ...
						    $query = "select src from songs where UserId in(select UserId from users where FirstName='Yangyan');";
